                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-sm text-gray-300">
                      <p>г. Новороссийск</p>
                      <p>ул. Хворостьянского, 4</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center space-x-3">
                    <Phone className="w-5 h-5 text-blue-400" />
                    <a href="tel:+78617123456" className="text-sm text-gray-300 hover:text-blue-400 transition-colors">
                      +7 (8617) 12-34-56
                    </a>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="mailto:info@sk-fullhouse.com" className="text-sm text-gray-300 hover:text-blue-400 transition-colors">
          ...
          <div className="border-t border-primary-foreground/20 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="text-sm text-primary-foreground/60">
                © {currentYear} Fullhouse. Все права защищены.
              </div>
