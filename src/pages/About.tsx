          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6">
              {[
                ...
                { year: '2023 — Признание', text: 'Лицензии и сертификаты качества, 30+ семей получили ключи от своих домов.' },
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { role: 'Прораб', pts: ['10 лет опыта','Контроль качества работ','Координация бригад'] },
              ].map((m, idx) => (
                <Card key={idx} className="border-0 shadow-xl ring-1 ring-slate-200/60 rounded-2xl">
                  <CardContent className="p-6">
