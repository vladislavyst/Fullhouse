          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-muted-foreground text-lg">
                Компания Fullhouse специализируется на строительстве частных домов под ключ в Новороссийске и прилегающих районах. За 3 года работы мы помогли более 25 семьям обрести собственное жилье, сочетая современные технологии с проверенными материалами.
              </p>
            </div>
          </div>
        </section>
