...
export const seoConfigs = {
  home: {
    ...
    description: "🏠 Строительство частных домов и коттеджей под ключ в Новороссийске. ⭐ 15+ лет опыта, 2500+ проектов, 98% довольных клиентов. Полный цикл от проекта до ключей. Гарантия качества!",
